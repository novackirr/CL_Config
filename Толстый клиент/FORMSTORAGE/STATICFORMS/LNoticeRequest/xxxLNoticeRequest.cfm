...
<FORM name="LNoticeRequest" LinkPath="|Лот" Script="
Sub Form_Load
...
End Sub" position="0,0,603,250" ScriptLang="VBScript" Font="propid=-512;name=MS Sans Serif;height=9;weight=400;italic=0;underline=0;strikeout=0;orientation=0;width=0;charset=0"><CONTROL name="AXDocumentLinksControl" LinkPath="#nodatalink#" controltype="C_ACTIVEX" ProgID="AXDOCUMENTLINKS.AXDocumentLinksCtrl.1" position="8,4,595,244" StaticTextFont="propid=1;name=MS Shell Dlg;height=12;weight=400;italic=0;underline=0;strikeout=0;orientation=0;width=0;charset=204" ButtonTextFont="propid=3;name=MS Shell Dlg;height=12;weight=400;italic=0;underline=0;strikeout=0;orientation=0;width=0;charset=204" EditeTextFont="propid=4;name=MS Shell Dlg;height=12;weight=400;italic=0;underline=0;strikeout=0;orientation=0;width=0;charset=204" ReadOnly="propid=5;Нет" IsExtended="propid=6;Нет" Flow="propid=7;" Columns="propid=8;Num;№;30;Num;;True;False|/Document/Номер_запроса;Номер запроса;100;String|/Document/Дата_публикации_запроса;Дата публикации запроса;150;Date|/Document/Опубликован_ответ;Опубликован ответ;120;Bool|/Document/Дата_публикации_разъяснения;Дата публикации разъяснения;180;Date|" SettingsFunkNameName="propid=9;" SettingsNewLinkName="propid=10;" FilterFlow="propid=11;Запросы на разъяснение" ShowHeaders="propid=12;Да" SettingsDeleteLinkName="propid=13;" AddButtonText="propid=14;-"/></FORM>
<?BinaryFile xxxLNoticeRequest.fbin?>
