...
<FORM name="LDogovorIsp" LinkPath="#nodatalink#" Script="Sub Form_Load
...
End Sub" position="0,0,610,123" ScriptLang="VBScript" Font="propid=-512;name=MS Sans Serif;height=9;weight=400;italic=0;underline=0;strikeout=0;orientation=0;width=0;charset=0"><CONTROL name="AXDocumentAttachmentsControl" LinkPath="#nodatalink#" controltype="C_ACTIVEX" ProgID="AXDOCUMENTATTACH.AXDocumentAttachCtrl.1" position="8,4,599,112" StaticTextFont="propid=2;name=MS Shell Dlg;height=12;weight=400;italic=0;underline=0;strikeout=0;orientation=0;width=0;charset=204" ButtonTextFont="propid=3;name=MS Shell Dlg;height=12;weight=400;italic=0;underline=0;strikeout=0;orientation=0;width=0;charset=204" EditeTextFont="propid=4;name=MS Shell Dlg;height=12;weight=400;italic=0;underline=0;strikeout=0;orientation=0;width=0;charset=204" ReadOnly="propid=5;Да" FilterCategory="propid=6;Исполнение" Columns="propid=7;Number;Number;№;30;False;|ToolDictionary:Вид документа исполнения контракта;VidDoc;Вид документа;250;true;;|ToolDictionary:Тип документа подтверждения исполнения контракта&amp;Наименование;DocName;Тип документа подтверждения;280;true;|String;docRegNumber;Номер в ЕИС;150;false|LongString;docDescription;Описание документа;250;true|FileName;FileName;Название файла; 310;false;|Version;Version;Версия;170;false;| Modified;Modified;Изменен;170;false;|LastModifiedDate;LastModifiedDate;Дата последнего изменения;170;false;|" StructName="propid=8;Исполнение"/></FORM>
<?BinaryFile xxxLDogovorIsp.fbin?>
