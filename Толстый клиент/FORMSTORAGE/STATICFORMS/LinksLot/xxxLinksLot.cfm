...
<FORM name="LinksLot" LinkPath="|Связки" Script="Sub subdostup
...
End Sub" position="0,0,607,283" ScriptLang="VBScript" Font="propid=-512;name=MS Sans Serif;height=9;weight=400;italic=0;underline=0;strikeout=0;orientation=0;width=0;charset=0"><CONTROL name="AXDocumentLinksControl" LinkPath="#nodatalink#" controltype="C_ACTIVEX" ProgID="AXDOCUMENTLINKS.AXDocumentLinksCtrl.1" position="8,26,599,278" StaticTextFont="propid=1;name=MS Shell Dlg;height=12;weight=400;italic=0;underline=0;strikeout=0;orientation=0;width=0;charset=204" ButtonTextFont="propid=3;name=MS Shell Dlg;height=12;weight=400;italic=0;underline=0;strikeout=0;orientation=0;width=0;charset=204" EditeTextFont="propid=4;name=MS Shell Dlg;height=12;weight=400;italic=0;underline=0;strikeout=0;orientation=0;width=0;charset=204" ReadOnly="propid=5;Нет" IsExtended="propid=6;Нет" Flow="propid=7;" Columns="propid=8;Num;№;40;Num;;True;False|/Document/Наименование_позиции;Наименование;300;String|/Document/Единица_измерения;Ед.измерения;100;String|/Document/Количество;Количество;100;Int|/Document/Сумма;Сумма;100;String|/Document/Валюта;Валюта;120;String|/Document/Срок_исполнения_договора;Срок исполнения;100;Date|/Document/Подразделение_получатель/Подразделение_получатель;Подразделение;200;String|" SettingsFunkNameName="propid=9;/Document/Сумма;SUM;Позиции;/Document/НМЦ|/Document/Фактическая_дата_размещения;FIRST;Извещения о закупочной процедуре;/Document/Фактическая_дата_размещения|/Document/Название_закупки;FIRST;Извещения о закупочной процедуре;/Document/Название_закупки|/Document/Номер_извещения;FIRST;Извещения о закупочной процедуре;/Document/Номер_извещения|/Document/Валюта;FIRST;Позиции;/Document/Валюта|/Document/Цифровой_код_валюты;FIRST;Позиции;/Document/Цифровой_код_валюты|/Document/Код_валюты;FIRST;Позиции;/Document/Код_валюты|" SettingsNewLinkName="propid=10;" FilterFlow="propid=11;Позиции" ShowHeaders="propid=12;Нет" SettingsDeleteLinkName="propid=13;" AddButtonText="propid=14;-"/><CONTROL name="RefreshLinkFrmbutControl" LinkPath="#nodatalink#" controltype="C_BUTTON" ProgID="FRMBUT.FrmbutCtrl.1" position="533,4,599,24" Style="propid=1;1" Caption="propid=-518;Обновить" Action="propid=2;RefreshLink" RadioKey="propid=3;" Check="propid=5;Нет" EventName="propid=4;" Enabled="propid=-514;Да" Font="propid=-512;name=Arial;height=9;weight=400;italic=0;underline=0;strikeout=0;orientation=0;width=0;charset=204" BackColor="propid=-501;15790320"/><CONTROL name="AddItemToTheLotFrmbutControl" LinkPath="#nodatalink#" controltype="C_BUTTON" ProgID="FRMBUT.FrmbutCtrl.1" position="463,4,528,24" Style="propid=1;1" Caption="propid=-518;Добавить позицию" Action="propid=2;LinkAddEvent/AddItemToTheLot" RadioKey="propid=3;" Check="propid=5;Нет" EventName="propid=4;" Enabled="propid=-514;Да" Font="propid=-512;name=Arial;height=9;weight=400;italic=0;underline=0;strikeout=0;orientation=0;width=0;charset=204" BackColor="propid=-501;15790320"/><CONTROL name="Status" LinkPath="|..|Document|Статус" controltype="C_IDLEINPUT" ProgID="CTLCtrl.TextboxCtrl.1" position="486,13,488,17" Font="propid=-512;name=Arial;height=9;weight=400;italic=0;underline=0;strikeout=0;orientation=0;width=0;charset=204" Text="propid=-517;" hWnd="propid=-515;2099820" BackColor="propid=-501;16777215" Multiline="propid=1;Нет" Mask="propid=2;" ReadOnly="propid=3;Да" ForeColor="propid=-513;0" MaxChar="propid=4;-1" TextAlign="propid=5;0"/></FORM>
<?BinaryFile xxxLinksLot.fbin?>
