//Возможно стоит использовать альтернативу https://github.com/bankrot/cadesplugin. У неё есть преимущество "Не запускает проверку плагина сразу при загрузке файла".
; (function () {
    //already loaded
    ...
    // Функция активации объектов КриптоПро ЭП Browser plug-in
    ...
    // Функция активации асинхронных объектов КриптоПро ЭП Browser plug-in
        ...
        if (!window.cadesplugin_skip_extension_install)
        {
            document.addEventListener('DOMContentLoaded', function() {
                ...
                ovr.innerHTML = "<div id='cadesplugin_ovr_item' style='position:relative; width:400px; margin:100px auto; background-color:#fff; border:2px solid #000; padding:10px; text-align:center; opacity: 1; z-index: 1500'>" +
                                ...
                                "<p>Для работы КриптоПро ЭП Browser plugin на данном сайте необходимо установить расширение из каталога дополнений Opera." +
